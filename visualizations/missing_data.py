...
class MissingData:
    ...
    ********** Removing Features or Removing Rows **********
    ...
    def __init__(self, visualize=True):
        self.df = pd.read_csv("../../../../files/final_files/DATA/ALTERED/Ames_outliers_removed.csv")
        self.visualize = visualize

    def get_data_detailed_info(self):
        with open('../../../../files/final_files/DATA/Ames_Housing_Feature_Description.txt','r') as f: 
            print(f.read())
    ...
    def missing_data_imputation(self):
        ...
        try:
            ...
            self.df.to_csv("../../../../files/final_files/DATA/ALTERED/Ames_NO_Missing_Data.csv",index=False)
