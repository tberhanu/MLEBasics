...
class PandasIntro:
    ...
    def pandas_basics(self):
        ...
        df = pd.read_csv('../../../../files/final_files/DATA/tips.csv')
    ...
    def dataframe04_missing_data(self):
        ...
        df = pd.read_csv('../../../../files/final_files/DATA/movie_scores.csv')
    ...
    def df05_groupby_isin_and_select_dtypes(self):
        df = pd.read_csv('../../../../files/final_files/DATA/mpg.csv')
    ...
    def pandas08_time_methods(self):
        ...
        sales = pd.read_csv('../../../../files/final_files/DATA/RetailSales_BeerWineLiquor.csv')
        ...
        sales = pd.read_csv('../../../../files/final_files/DATA/RetailSales_BeerWineLiquor.csv',parse_dates=[0])
    ...
    def pandas09_csv_html_excel(self):
        df = pd.read_csv('../../../../files/final_files/DATA/example.csv') # READING
        ...
        df.to_csv('../../../../files/final_files/DATA/new_file.csv',index=False) # WRITING
        ...
        ### EXCEL
        excel_sheet_df = pd.read_excel('.../../../../files/final_files/03-Pandas/my_excel_file.xlsx',sheet_name='First_Sheet') # specific sheet_name

        lst_of_sheet_names = pd.ExcelFile('../../../../files/final_files/03-Pandas/my_excel_file.xlsx').sheet_names

        excel_sheets_dfs = pd.read_excel('../../../../files/final_files/03-Pandas/my_excel_file.xlsx',sheet_name=None) # Grab all sheets
        single_sheet = excel_sheets_dfs['First_Sheet']
    
        single_sheet.to_excel('../../../../files/final_files/03-Pandas/example2.xlsx',sheet_name='First_Sheet',index=False) # WRITE
    ...
    def pandas09_pivot_table(self):
        ...
        ** What type of question does a pivot help answer?**
        ...
        """
        df = pd.read_csv('../../../../files/final_files/03-Pandas/Sales_Funnel_CRM.csv')
