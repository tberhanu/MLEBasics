...
class PlottingResiduals:
	...
	def quartet1(self):
		quartet = pd.read_csv("../../../../files/final_files/DATA/anscombes_quartet/anscombes_quartet1.csv")
		self.visualize(quartet)

	def quartet2(self):
		quartet = pd.read_csv('../../../../files/final_files/DATA/anscombes_quartet/anscombes_quartet2.csv')
		self.visualize(quartet)


	def quartet4(self):
		quartet = pd.read_csv('../../../../files/final_files/DATA/anscombes_quartet/anscombes_quartet4.csv')
		self.visualize(quartet)
